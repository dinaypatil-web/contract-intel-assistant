...
export const LetterReviewStudio: React.FC<LetterReviewStudioProps> = ({
  ...
  const [questionnaireState, setQuestionnaireState] = useState<QuestionnaireQuestion[]>(letter.questionnaire);
  const [matrixState] = useState<ResponseMatrixRow[]>(letter.responseMatrix);
  ...
  const currentDraftText = customDraft || generateFormalContractReply(
    selectedTone,
    `APX/MRC/L4-C02/LTR-${Math.floor(1000 + Math.random() * 9000)}`,
    letter.refNumber,
    letter.date,
    letter.sender,
    project.contractor,
        ...
        <div className="symmetric-grid-2col">
          <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div className="panel-header">
              ...
              <span className="badge badge-neutral">PMC Letter LTR-1482</span>
            </div>
            <div style={{
